...
const Newsletter = () => {
    return (
        ...
        <div className="flex flex-col relative p-10">
            <div className="text-black ml-5 px-4 py-10 xl:px-24 xl:py-20 justify-center items-center md:flex-row gap-2">
            <div className="xl:w-full sm:w-full md:w-full md:flex flex-col md:flex-row">
                <form className="mt-4 flex flex-col md:flex-row w-full">
                <input
                    type="email"
                    placeholder="Enter your email"
                    className="p-2 border border-gray-300 rounded-t-md md:rounded-l-md md:rounded-r-none w-full"
                />
                <button
                    type="submit"
            ...
            <div className="sm:w-full sm:mt-10 xl:w-full lg:w-full lg:pt-5 xl:text-right sm:text-center lg:text-center md:text-center  md:mt-0">
